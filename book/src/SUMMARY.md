...
[Introduction](chapter_01_introduction.md)

# Part I: Foundations
- [Tensors: The Bedrock](chapter_02_tensors.md)
- [Automatic Differentiation](chapter_03_autograd.md)

# Part II: Neural Networks & Attention
- [Building Blocks](chapter_04_nn.md)
- [The Mechanics of Attention](chapter_05_attention.md)
